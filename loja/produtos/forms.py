...
class Addprodutos(Form):
    ...
    image_2 = FileField('Image 1 :' , validators=[FileRequired(),FileAllowed(['jpg','png','gif','jpeg'])])
    image_3 = FileField('Image 1 :' , validators=[FileRequired(),FileAllowed(['jpg','png','gif','jpeg'])])
